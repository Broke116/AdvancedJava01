...
public class FormThread implements Runnable {
    ...
    private ThreadLocal<Integer> randomInteger = new ThreadLocal<Integer>();
    ...
    public void run() {
        ...
        randomInteger.set((int) (Math.random() * 100D));
        System.out.println("Random value generated by each thread. " + randomInteger.get());
